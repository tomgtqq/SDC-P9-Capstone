...
class WaypointUpdater(object):
    ...
    def generate_lane(self):
        ...
        # didn't detect any traffic light data or fraffic light far away
    ...
    def decelerate_waypoints(self, waypoints, closest_idx):
        ...
        for i, wp in enumerate(waypoints):
            ...
            # just keep the speed limit when car is a long way away from the stop waypoint.
            # as the square root becomes smaller then the speed limit. switch vel
