...
class TLDetector(object):
    def __init__(self):
        ...
        # provides the complete list of waypoints
    ...
    def get_light_state(self, light):
        ...
        """
        # simulate data testing, the traffic lights come in from the simulator with the state already
        return light.state
